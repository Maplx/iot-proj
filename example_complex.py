...
def build_example_platform_complex() -> Platform:
    ...
    # End systems
    es0 = EndSystem(id="ES0", name="Front-Sensor ECU", cu_ids=["ES0.CPU0", "ES0.GPU0"])
    es1 = EndSystem(id="ES1", name="Central-Compute ECU", cu_ids=["ES1.CPU0", "ES1.GPU0"])
    ...
    # SW0 <-> SW1
    add_link("L_SW0_SW1", "SW0", "SW1", delay=2)
    add_link("L_SW1_SW0", "SW1", "SW0", delay=2)

    # SW1 <-> ES2
    add_link("L_SW1_ES2", "SW1", "ES2", delay=1)
    add_link("L_ES2_SW1", "ES2", "SW1", delay=1)

    return Platform(
        end_systems={es0.id: es0, es1.id: es1, es2.id: es2},
        switches={sw0.id: sw0, sw1.id: sw1},
        computing_units={
            cu_es0_cpu.id: cu_es0_cpu,
            cu_es0_gpu.id: cu_es0_gpu,
            cu_es1_cpu.id: cu_es1_cpu,
            cu_es1_gpu.id: cu_es1_gpu,
